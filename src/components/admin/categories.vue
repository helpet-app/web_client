                                    ...
                                    <table class="datatable table table-hover table-center mb-0">
                                        ...
                                        <tbody>
                                            <tr v-for="item in categories" :key="item.id">
                                                ...
                                                <td class="text-right">
                                                    <div class="actions">
                                                        <a class="btn btn-sm bg-success-light mr-2" data-toggle="modal" href="#edit_modal">
							...
							<div class="card">
								<div class="card-body">
					                <form id="update_category" method="post" autocomplete="off" enctype="multipart/form-data" novalidate="novalidate" class="bv-form"><button type="submit" class="bv-hidden-submit" style="display: none; width: 0px; height: 0px;"></button>
					                    ...
					                    <div class="mt-4">
					                        <button class="btn btn-primary mr-2" name="form_submit" value="submit" type="submit">Save Changes</button>
