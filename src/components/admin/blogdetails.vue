									...
									<div class="row">
										<div class="col-12 blog-details">
											...
											<div class="blog-details-img">
												<img class="img-fluid" src="../../assets/img/admin/blog/blog-01.jpg" alt="Post Image">
											</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="about-author pt-4 d-flex align-items-center">
										<div class="left">
											<img class="rounded-circle" src="../../assets/img/admin/profiles/avatar-12.jpg" width="120" alt="Ryan Taylor">
										</div>
										<div class="right">
											<h5>Linda Barrett</h5>
