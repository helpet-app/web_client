                                        ...
                                        <div class="navbar">
                                            <div class="user-details mr-auto">
                                                <div class="float-left user-img">
                                                    <router-link class="avatar avatar-sm mr-2" to="/mentee/mentor-profile" title="Jonathan Doe">
                                                        <img src="../../../assets/img/website/user/user.jpg" alt="User Image" class="rounded-circle">
                                                        <span class="status online"></span>
                                                    </router-link>
                                                </div>
                                                <div class="user-info float-left">
                                                    <router-link to="/mentee/mentor-profile"><span>Jonathan Doe</span></router-link>
                                    ...
                                    <div class="call-contents">
                                        <div class="call-content-wrap">
                                            <div class="voice-call-avatar">
                                                <img src="../../../assets/img/website/user/user2.jpg" alt="User Image" class="call-avatar">
                                            ...
                                            <div class="call-users">
                                                <ul>
                                                    <li>
                                                        <a href="#">
                                                            <img src="../../../assets/img/website/user/user.jpg" class="img-fluid" alt="User Image">
