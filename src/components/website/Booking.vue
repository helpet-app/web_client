					...
					<div class="row">
						<div class="col-12">
							...
							<div class="card">
								<div class="card-body">
									<div class="booking-user-info">
										<router-link to="mentee/mentor-profile" class="booking-user-img">
											<img src="../../assets/img/website/user/user2.jpg" alt="User Image">
										</router-link>
										<div class="booking-info">
											<h4><router-link to="mentee/mentor-profile" >Tyrone Roberts</router-link></h4>
											<div class="rating">
							...
							<div class="submit-section proceed-btn text-right">
								<router-link to="/mentee/checkout" class="btn btn-primary submit-btn">Proceed to Pay</router-link>
							</div>
							<!-- /Submit Section -->
