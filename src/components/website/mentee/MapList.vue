                            ...
                            <div class="row align-items-center mb-4">
                                ...
                                <div class="col-md-6 col-auto">
                                    <div class="view-icons">
                                        <router-link to="/mentee/map-grid" class="grid-view"><i class="fas fa-th-large"></i></router-link>
                                        <router-link to="/mentee/map-grid" class="list-view active"><i class="fas fa-bars"></i></router-link>
                                    </div>
                                    ...
                                    <div class="mentor-widget">
                                        <div class="user-info-left">
                                            ...
                                            <div class="user-info-cont">
                                                <h4 class="usr-name"><router-link to="/mentee/mentor-profile">{{item.mentor_name}}</router-link></h4>
                                                ...
                                                <div class="mentor-details">
                                                    <p class="user-location"> <i class="fas fa-map-marker-alt"></i> {{item.location1}} </p>
                                                </div>
                                            </div>
                                        </div>
    ...
    methods: {
			...
			'<div class="profile-widget" style="width: 100%; display: inline-block;">'+
				'<div class="doc-img">'+
					'<a href="' + marker.profile_link + '" tabindex="0" target="_blank">'+
						'<img alt="' + marker.doc_name + '" src="' + this.loadImg(marker.image) + '">'+
					'</a>'+
				'</div>'+
		...
		setMarkers(map, markers) {
			...
			'<div class="profile-widget" style="width: 100%; display: inline-block;">'+
				'<div class="doc-img">'+
					'<a href="' + marker.profile_link + '" tabindex="0" target="_blank">'+
						'<img class="img-fluid" alt="' + marker.doc_name + '" src="'+ this.loadImg(marker.image) +'">'+
					'</a>'+
				'</div>'+
				'<div class="pro-content">'+
					'<h3 class="title">'+
