									...
									<form>
										...
										<div class="payment-widget">
											...
											<div class="submit-section mt-4">
												<button type="button" @click="$router.push('/mentee/booking-success')" class="btn btn-primary submit-btn">Confirm and Pay</button>
											</div>
											<!-- /Submit Section -->
							...
							<div class="card booking-card">
								...
								<div class="card-body">
									...
									<div class="booking-user-info">
										<router-link to="/payment-mentee" class="booking-user-img">
											<img src="../../../assets/img/website/user/user2.jpg" alt="User Image">
										</router-link>
										<div class="booking-info">
											<h4><router-link to="/payment-mentee">Darren Elder</router-link></h4>
											<div class="rating">
