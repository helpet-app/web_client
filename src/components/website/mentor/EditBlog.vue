										...
										<div class="card-body">	
											...
											<form>
																...
																<ul class="upload-wrap">
																	<li>
																		<div class="upload-images">
																			...
																			<img alt="" src="../../../assets/img/website/blog/blog-thumb-01.jpg">
																		</div>
																	</li>
																	<li>
																		<div class="upload-images">

																			<img alt="" src="../../../assets/img/website/blog/blog-thumb-02.jpg">
																		</div>
																	</li>
																	<li>
																		<div class="upload-images">

																			<img alt="" src="../../../assets/img/website/blog/blog-thumb-03.jpg">
																		</div>
																	</li>
																</ul>
															</div>
												...
												<div class="submit-section">
													<button class="btn btn-primary submit-btn" type="button" @click="$router.push('/mentor/blog')" name="form_submit" value="submit">Submit</button>
												</div>
											</form>
