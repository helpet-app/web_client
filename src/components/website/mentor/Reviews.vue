						...
						<div class="col-md-7 col-lg-8 col-xl-9">
							<div class="doc-review review-listing">
								...
								<ul class="comments-list">
									...
									<li>
										<div class="comment">
											<img class="avatar rounded-circle" alt="User Image" src="../../../assets/img/website/user/user.jpg">
									...
									<li>
										<div class="comment">
											<img class="avatar rounded-circle" alt="User Image" src="../../../assets/img/website/user/user3.jpg">
											<div class="comment-body">
												<div class="meta-data">
