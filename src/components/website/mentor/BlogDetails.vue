							...
							<div class="blog-view">
								<div class="blog blog-single-post">
									<div class="blog-image">
										<a href="javascript:void(0);"><img alt="" src="../../../assets/img/website/blog/blog-01.jpg" class="img-fluid"></a>
									</div>
											...
											<ul>
												<li>
													<div class="post-author">
														<router-link  to="/mentee/mentor-profile"><img src="../../../assets/img/website/user/user.jpg" alt="Post Author"> <span>Marvin Downey</span></router-link >
													</div>
												</li>
									...
									<div class="about-author">
										<div class="about-author-img">
											<div class="author-img-wrap">
												<router-link  to="/mentee/mentor-profile"><img class="img-fluid rounded-circle" alt="" src="../../../assets/img/website/user/user1.jpg"></router-link >
											</div>
										</div>
										<div class="author-details">
											<router-link  to="/mentee/mentor-profile" class="blog-author-name">Darren Elder</router-link >
								...
								<div class="card blog-comments clearfix">
									...
									<ul class="comments-list">
										<li>
											<div class="comment">
												<div class="comment-author">
													<img class="avatar" alt="" src="../../../assets/img/website/user/user4.jpg">
												</div>
											...
											<ul class="comments-list reply">
												<li>
													<div class="comment">
														<div class="comment-author">
															<img class="avatar" alt="" src="../../../assets/img/website/user/user5.jpg">
														</div>
														<div class="comment-block">
															<span class="comment-by">
												...
												<li>
													<div class="comment">
														<div class="comment-author">
															<img class="avatar" alt="" src="../../../assets/img/website/user/user3.jpg">
														</div>
														<div class="comment-block">
															<span class="comment-by">
										...
										<li>
											<div class="comment">
												<div class="comment-author">
													<img class="avatar" alt="" src="../../../assets/img/website/user/user6.jpg">
												</div>
												<div class="comment-block">
													<span class="comment-by">
										...
										<li>
											<div class="comment">
												<div class="comment-author">
													<img class="avatar" alt="" src="../../../assets/img/website/user/user7.jpg">
												</div>
												<div class="comment-block">
													<span class="comment-by">
